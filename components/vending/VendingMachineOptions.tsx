 ...
 * 
 * Using the accessibility-compliant color scheme:
 * - Primary Black (#000000)
 * - Silver (#A5ACAF)
 * - Orange Accent (#FD5A1E)
 * - Whitesmoke (#F5F5F5)
 * - Dark Gray (#4d4d4d)
 * - Edward Gray (#a4acac)
 * - Santas Gray (#a4a4ac)
        ...
        {selectedMachine && (
          <div className="mt-12 bg-[#4d4d4d] p-6 rounded-xl border border-[#a4acac]">
            ...
            <div className="mt-8 text-center">
              <button
                type="button"
                className="inline-flex items-center px-4 py-2 border-transparent rounded-md shadow-sm text-sm font-medium text-[#F5F5F5] bg-[#FD5A1E] hover:bg-[#000000] hover:text-[#FD5A1E] hover:border-[#FD5A1E] border focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#FD5A1E]"
